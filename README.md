...
For demo/testing purposes this could be with Kafka running on localhost using
generate_event_data.py (see Generating fake event data below) or with just-bin-it running in simulation mode.
